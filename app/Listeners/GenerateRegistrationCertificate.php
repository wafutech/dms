...
class GenerateRegistrationCertificate
{
    /**
     ...
     * Handle the event.
     *
     * @param  MemberRegistrationEvent  $event
     * @return void
     */
    public function handle(MemberRegistrationEvent $event)
    {
        //
        $member = Member::find($event->memberid)->toArray();
